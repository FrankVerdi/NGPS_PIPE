...
import numpy as np
from ngps_pipe import manual_aperture
from ngps_pipe.gui_helpers import HelpTool
...
class ManualTracingGUI:
    ...
    def plot(self):
        ...
        self.axes.clear()
        self.canvas.parent().setWindowTitle(self.target)
