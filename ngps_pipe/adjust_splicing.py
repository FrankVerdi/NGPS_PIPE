...
from ngps_pipe.splicing import adjust_and_combine_overlap
...
def parse(options: Optional[List[str]] = None) -> argparse.Namespace:
    argparser = argparse.ArgumentParser(description="Splicing adjustment for P200 NGPS",
        formatter_class=argparse.RawTextHelpFormatter)

    argparser.add_argument("fname", type=str, nargs="+", help="Final data "
        "output from NGPS_PIPE to adjust the splicing of. Can be one or "
        "multiple files.")
