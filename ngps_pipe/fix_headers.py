...
def main(path_prefix: str, throw_errors: bool, prompt_user: bool) -> List[str]:
    ...
    for common NGPS errors: empty file, extra bytes at the end, swapped
        ...
        with fits.open(path, mode='update') as hdul:
            header = hdul[0].header
                ...
                #while not ra_good:
                    ...
                    #print("Though RA can be corrected later if you ran ngps_reduce without -i")
                    #ra_good = _get_ra_or_dec(fname, True, header, modified_str, True)
                ...
                #while not dec_good:
                    ...
                    #print("Though DEC can be corrected later if you ran ngps_reduce without -i")
                    #dec_good = _get_ra_or_dec(fname, False, header, modified_str, True)
            #else:
