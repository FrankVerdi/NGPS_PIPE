"""
All-purpose interactive spectrum plotter for NGPS_PIPE and intermediate PypeIt files.
"""
import argparse
import os
import sys
...
def parser(options: Optional[List[str]] = None) -> argparse.Namespace:
    argparser = argparse.ArgumentParser(description="All-purpose interactive "
        "spectrum plotter for NGPS_PIPE and intermediate PypeIt files.",
