...
NGPS_PIPE automates the reduction and fluxing, telluric correction of one night's data.
...
- manually place traces for manually "forced" spectroscopy with the `-m` option
